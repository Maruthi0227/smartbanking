 ...
 <header class="main-header">
    ...
    <div class="animated slideInLeft">
        ...
        <a href="deposit.php">
          ...
          <i class="fas fa-rupee-sign"></i> Request</a>
        <a href="withdrawal.php">
            <i class="fas fa-rupee-sign"></i></i> Withdraw</a>
        <a href="transaction.php">
           <i class="fas fa-exchange-alt"></i> Transaction</a>
        <a href="t_history.php">
...
<section class="contact-section">
    <article class="contact-article animated jackInTheBox">
         <h2>Requets</h2>
        <form class="contact-form" action="requestmail.php" method="POST">
            ...
            <br>
            <input type="number" class="input-field" name="phone" placeholder="Mobile Number">
            <br>
            <input type="text" class="input-field" name="aadhar" placeholder="Aadhar Number">
            <br>
            <input type="text" class="input-field" name="accountnumber" placeholder="Account Number">
            <br>
            <input type="text" class="input-field" name="message" placeholder="Text Filed">
            <br>
...
<footer class="main-footer">
    ...
    <p>Developed & Maintained by
        <a href="" target="_blank">
            <i class="fa fa-users"></i>Smart Banking.
        </a>
    </p>
</footer>
</body>
